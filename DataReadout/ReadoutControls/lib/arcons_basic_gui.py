...
#
# Created: Sun Sep 02 14:29:05 2012
...
class Ui_arcons(object):
    def setupUi(self, arcons):
        ...
        self.label_2.setGeometry(QtCore.QRect(140, 0, 261, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Arial"))
        font.setPointSize(18)
        font.setWeight(75)
        ...
        self.textEdit.setGeometry(QtCore.QRect(10, 250, 371, 101))
        self.textEdit.setObjectName(_fromUtf8("textEdit"))
        self.label_27 = QtGui.QLabel(self.frame_3)
        self.label_27.setGeometry(QtCore.QRect(10, 230, 151, 17))
        self.label_27.setObjectName(_fromUtf8("label_27"))
        self.update_description = QtGui.QPushButton(self.frame_3)
        self.update_description.setGeometry(QtCore.QRect(10, 351, 141, 31))
        ...
        self.label_22.setGeometry(QtCore.QRect(941, 300, 91, 21))
        self.label_22.setObjectName(_fromUtf8("label_22"))
        self.takesky = QtGui.QPushButton(self.centralwidget)
        self.takesky.setGeometry(QtCore.QRect(870, 340, 171, 51))
        ...
        self.label_36.setGeometry(QtCore.QRect(40, 10, 101, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Arial"))
        font.setPointSize(18)
        font.setWeight(75)
        ...
        self.cal_time.setGeometry(QtCore.QRect(20, 170, 57, 25))
        ...
        self.cal_angle.setGeometry(QtCore.QRect(90, 170, 62, 25))
        ...
        self.goto_button.setGeometry(QtCore.QRect(10, 210, 71, 71))
        self.goto_button.setObjectName(_fromUtf8("goto_button"))
        self.label_40 = QtGui.QLabel(self.frame_7)
        self.label_40.setGeometry(QtCore.QRect(40, 290, 121, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Arial"))
        font.setPointSize(18)
        font.setWeight(75)
        ...
        self.filterpos_spinbox = QtGui.QSpinBox(self.frame_7)
        self.filterpos_spinbox.setGeometry(QtCore.QRect(100, 330, 57, 25))
        self.filterpos_spinbox.setMinimum(1)
        self.filterpos_spinbox.setMaximum(6)
        self.filterpos_spinbox.setObjectName(_fromUtf8("filterpos_spinbox"))
        self.label_41 = QtGui.QLabel(self.frame_7)
        self.label_41.setGeometry(QtCore.QRect(10, 330, 81, 21))
        self.label_41.setObjectName(_fromUtf8("label_41"))
        self.filt1label = QtGui.QLabel(self.frame_7)
        self.filt1label.setGeometry(QtCore.QRect(30, 360, 141, 21))
        self.filt1label.setObjectName(_fromUtf8("filt1label"))
        self.filt2label = QtGui.QLabel(self.frame_7)
        self.filt2label.setGeometry(QtCore.QRect(30, 380, 141, 21))
        self.filt2label.setObjectName(_fromUtf8("filt2label"))
        self.filt3label = QtGui.QLabel(self.frame_7)
        self.filt3label.setGeometry(QtCore.QRect(30, 400, 141, 21))
        self.filt3label.setObjectName(_fromUtf8("filt3label"))
        self.filt4label = QtGui.QLabel(self.frame_7)
        self.filt4label.setGeometry(QtCore.QRect(30, 420, 141, 21))
        self.filt4label.setObjectName(_fromUtf8("filt4label"))
        self.filt5label = QtGui.QLabel(self.frame_7)
        self.filt5label.setGeometry(QtCore.QRect(30, 440, 141, 21))
        self.filt5label.setObjectName(_fromUtf8("filt5label"))
        self.filt6label = QtGui.QLabel(self.frame_7)
        self.filt6label.setGeometry(QtCore.QRect(30, 460, 141, 21))
        self.filt6label.setObjectName(_fromUtf8("filt6label"))
...
" Pixel Number:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_41.setText(QtGui.QApplication.translate("arcons", "Current Pos.", None, QtGui.QApplication.UnicodeUTF8))
        self.filt1label.setText(QtGui.QApplication.translate("arcons", "1)", None, QtGui.QApplication.UnicodeUTF8))
        self.filt2label.setText(QtGui.QApplication.translate("arcons", "2)", None, QtGui.QApplication.UnicodeUTF8))
        self.filt3label.setText(QtGui.QApplication.translate("arcons", "3)", None, QtGui.QApplication.UnicodeUTF8))
        self.filt4label.setText(QtGui.QApplication.translate("arcons", "4)", None, QtGui.QApplication.UnicodeUTF8))
        self.filt5label.setText(QtGui.QApplication.translate("arcons", "5)", None, QtGui.QApplication.UnicodeUTF8))
        self.filt6label.setText(QtGui.QApplication.translate("arcons", "6)", None, QtGui.QApplication.UnicodeUTF8))
