...
for ipixel=2,nrows-1 do begin
  ...
  if(pcount GT 0) then begin
    ...
    device,filename=path+roach_str+pixel_str+'pulses-news.ps'
    ...
    openw,2,path+roach_str+pixel_str+'NoiseSpectra-new.dat'
    ...
    ; output templates and noise spectra
    openw,2,path+roach_str+pixel_str+'Template-2pass-new.dat'
    for i=0,1999 do begin
