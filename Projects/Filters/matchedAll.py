...
for roachNum in xrange(NRoach):
    allMatched = []
    savefile ='/Users/matt/Documents/mazin/filters/pulseData/20121204/matched20121204r%d.txt'%roachNum
    for pixelNum in xrange(NPixel):
        print roachNum,pixelNum 
        try:
            noisefile = '/Users/matt/Documents/mazin/filters/pulseData/20121204/r%dp%dNoiseSpectra-new.dat'%(roachNum,pixelNum)
