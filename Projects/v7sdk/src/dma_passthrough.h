...
// Company:        Xilinx
// Engineer:       bwiec
// Create Date:    07 July 2015, 1:06:59 PM
...
//     This is done using scatter gather. The current implementation still uses
//     contiguous buffer memory for simplicity and demonstration purposes, but
...
#define DMA_PASSTHROUGH_BD_SETUP_FAIL     -3
#define DMA_PASSTHROUGH_XFER_FAIL         -4
...
//
// dma_passthrough_set_num_bds_per_ring - Set the number of buffer descriptors in each ring to
//                                        use for DMA transfers.
//
//    - p_dma_passthrough_inst: Pointer to dma_passthrough_t object.
//    - num_bds_per_ring:       Number of buffer descriptors in each ring to use for DMA transfers.
//
void dma_passthrough_set_num_bds_per_ring(dma_passthrough_t* p_dma_passthrough_inst, int num_bds_per_ring);

//
// dma_passthrough_get_num_bds_per_ring - Get the number of buffer descriptors in each ring to
//                                        use for DMA transfers.
//
//  Arguments
//    - p_dma_passthrough_inst: Pointer to dma_passthrough_t object.
//
//  Return
//    - int:                    Number of buffer descriptors in each ring to use for DMA transfers.
//
