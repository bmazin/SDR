...
fname='SCI6_B140731-BobaFett_-80dBm_FL2_34kG'
outlabel = '-right'
filename = fname + '.txt'
datapath = '/home/kids/labData/20140914adr/'
;datapath2 = '/Users/matt/Documents/mazin/widesweepanalysis/20130117adr/'
outpath = '/home/kids/labData/20140914adr/'
...
data1[where(data1 GT 999999999.0)] = 0.0
data1[where(data1 LT -999999999.0)] = 0.0
m = lines/2-1
...
for i=0,numBreaks do begin  ; 0,79 should be!
  ...
  auto_peak_sensitivity = 7

  g2 = peaks(v1,auto_peak_sensitivity)
  g2 = peaks(-m,auto_peak_sensitivity)
  print,g2
