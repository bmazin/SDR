...
;-------------------------------------------------------------
	...
	function radon2, z0, start=a1, stop=a2, step=da, angles=ang, $
	  help=hlp, debug=debug, embed=nx0
 
	common radon2_com, xt0, yt0, nx00, a10, a20, da0
...
;	endif
	...
	if (nx>ny) gt nx0 then begin
	  print,' Error in Radon2: embed size must be larger than image size.'
	  return, -1
	endif
