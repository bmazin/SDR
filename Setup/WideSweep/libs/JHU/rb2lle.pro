...
;       RB2LLE
; PURPOSE:
;       From range and bearing on WGS84 ellipsoid compute a point.
; CATEGORY:
; CALLING SEQUENCE:
;       rb2lle, lng1, lat1, dist, azi1, lng2, lat2, azi2
; INPUTS:
...
;       FORTRAN code at ftp://www.ngs.noaa.gov/pub/pcsoft/for_inv.3d/source/forward.for
;       
...
;-
;-------------------------------------------------------------
	pro rb2lle, lng1, lat1, dist, azi1, lng2, lat2, azi2, help=hlp
 
	if (n_params(0) lt 6) or keyword_set(hlp) then begin
	  print,' From range and bearing on WGS84 ellipsoid compute a point.'
	  print,' rb2lle, lng1, lat1, dist, azi1, lng2, lat2, azi2'
